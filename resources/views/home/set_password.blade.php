       ...
       <div class="member-left fl">
        ...
        <div class="member-right fr">
            ...
            <div class="member-border">
                     <div class="form">
                              <form action="/home/set_password" method="post">
                                <div class="item">
                                    <span class="label">原密码:</span>
                                        <input clstag="homepage|keycount|home2013|infoname" type="password" class="itxt" maxlength="20" id="uName" name="oldpassword">
                                </div>
                                
                                <div class="item">
                                    <span class="label"><em>*</em>新密码：</span>
                                    <div class="fl">
                                        <input clstag="homepage|keycount|home2013|infoname" type="password" class="itxt" maxlength="20" id="mName" name="newpassword" >
