        ...
        <div class="member-right fr">
            ...
            <div class="member-border">
                <div class="member-form clearfix">
                    <form action="/home/flash" method="get">
                        <input type=text class="text-news" placeholder="商城快讯关键字"  value="{{$request->fname}}" name="fname">
                ...
                <div class="member-entry">
                    ...
                    <ul>
                        ...
                        <li class="clearfix"><div><a href="/home/content/{{$v->id}}">{{$v->fname}}</a></div><div>{{$v->ftime}}</div></li>
                        @endforeach
                    </ul>
                </div>
